...
from mks.database.ia_filterdb import get_search_results2
from mks.utils.utils import is_subscribed, get_size, temp
...
def get_reply_markup(query):
    buttons = [
        [
            ...
            InlineKeyboardButton('⚡𝖴𝗉𝖽𝖺𝗍𝖾𝗌 ⚡', url="https://t.me/YoeNaung")
        ]
        ]
