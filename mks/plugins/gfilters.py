...
from mks.utils.utils import get_file_id, gfilterparser, split_quotes
from ..config import Config


@Client.on_message(filters.command(['gfilter', 'addg']) & filters.incoming & filters.user(Config.ADMINS))
...
@Client.on_message(filters.command(['viewgfilters', 'gfilters']) & filters.incoming & filters.user(Config.ADMINS))
...
@Client.on_message(filters.command('delg') & filters.incoming & filters.user(Config.ADMINS))
...
@Client.on_message(filters.command('delallg') & filters.user(Config.ADMINS))
